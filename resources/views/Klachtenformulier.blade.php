...
<li>
    ...
    <nav class="formBody">
    <form action="">
            <form id="complaintForm" onsubmit="return false;"> <!-- Prevent default form submission -->
    ...
    <input type="tel" name="Telefoonnummer" id="Telefoonnummer" pattern="[0-9]{10}" required><br><br>
    ...
    <label for="klachtText" required>Uw klacht:</label><br>
    <textarea id="klachtText" rows="4" cols="50" required></textarea><br><br>
